...
/>
  ...
  <body>
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      <li  class="rd-nav-item active"><a style= "color:white;" class="rd-nav-link" href="index.php">Home</a>
                      </li>
                      <li  class="rd-nav-item active"><a data-toggle="modal" data-target="#exampleModal232"  style= "color:white;" class="rd-nav-link" href="suggestfood.php">Suggest Food</a>
                      </li>
      ...
      <div class="modal fade" id="exampleModal232" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Food Suggest🤔🤔<h5>
